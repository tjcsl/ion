...
from intranet.apps.eighth.models import EighthActivity, EighthSponsor, EighthRoom  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("-r", "--restricted", type=str, nargs="+", default=[],
                        choices=["freshman", "sophomore", "junior", "senior"], help="Restricts activity access to one grade")
