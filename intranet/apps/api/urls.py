...
urlpatterns = [
    ...
    url(r"^/profile/(?P<username>[A-Za-z0-9]+)/picture$",
        users_api.ProfilePictureDetail.as_view(), name="api_user_profile_picture_default_by_username"),
    url(r"^/profile/(?P<pk>[0-9]+)/picture/(?P<photo_year>[a-zA-Z]+)$", users_api.ProfilePictureDetail.as_view(), name="api_user_profile_picture"),
    url(r"^/profile/(?P<username>[A-Za-z0-9]+)/picture/(?P<photo_year>[a-zA-Z]+)$",
        users_api.ProfilePictureDetail.as_view(), name="api_user_profile_picture_by_username"),
    ...
    url(r"^/signups/user/favorites$", eighth_api.EighthUserFavoritesList.as_view(), name="api_eighth_user_favorites_list_myid"),
    url(r"^/signups/user/favorites/add$", eighth_api.EighthUserFavoritesAdd.as_view(), name="api_eighth_user_favorites_add_myid"),
    url(r"^/signups/user/favorites/remove$", eighth_api.EighthUserFavoritesRemove.as_view(), name="api_eighth_user_favorites_remove_myid"),
    url(r"^/signups/scheduled_activity/(?P<scheduled_activity_id>[0-9]+)$",
        eighth_api.EighthScheduledActivitySignupList.as_view(), name="api_eighth_scheduled_activity_signup_list"),
