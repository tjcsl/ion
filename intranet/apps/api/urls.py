...
urlpatterns = [
    ...
    url(r"^/profile/(?P<username>[A-Za-z\d]+)/picture$", users_api.ProfilePictureDetail.as_view(),
    ...
    url(r"^/profile/(?P<username>[A-Za-z\d]+)/picture/(?P<photo_year>[a-zA-Z]+)$", users_api.ProfilePictureDetail.as_view(),
