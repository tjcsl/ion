...
urlpatterns = [
    ...
    url(r"^/profile/(?P<username>[A-Za-z0-9]+)/picture$", users_api.ProfilePictureDetail.as_view(),
        name="api_user_profile_picture_default_by_username"),
    url(r"^/profile/(?P<pk>[0-9]+)/picture/(?P<photo_year>[a-zA-Z]+)$", users_api.ProfilePictureDetail.as_view(), name="api_user_profile_picture"),
    url(r"^/profile/(?P<username>[A-Za-z0-9]+)/picture/(?P<photo_year>[a-zA-Z]+)$", users_api.ProfilePictureDetail.as_view(),
