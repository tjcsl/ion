...
class UserManager(DjangoUserManager):
    ...
    def users_in_year(self, year: int) -> QuerySet[User]:  # pylint: disable=unsubscriptable-object
    ...
    def get_students(self) -> QuerySet[User]:  # pylint: disable=unsubscriptable-object
    ...
    def get_teachers(self) -> QuerySet[User]:  # pylint: disable=unsubscriptable-object
    ...
    def get_teachers_sorted(self) -> QuerySet[User]:  # pylint: disable=unsubscriptable-object
    ...
    def exclude_from_search(
        self,
        existing_queryset: QuerySet[User] | None = None,  # pylint: disable=unsubscriptable-object
    ) -> QuerySet[User]:  # pylint: disable=unsubscriptable-object
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    @property
    def schedule(self) -> QuerySet[Section] | None:  # pylint: disable=unsubscriptable-object
