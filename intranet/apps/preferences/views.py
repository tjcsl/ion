...
def supports_webpush_notifications(user_agent):
    ...
    if (user_agent.browser.family in ("Chrome", "Opera")) and user_agent.browser.version[0] >= 42:
        ...
        return True
    elif "Safari" in user_agent.browser.family and user_agent.os.family == "iOS":
        if user_agent.os.version[0] > 16 or (user_agent.os.version[0] == 16 and user_agent.os.version[1] >= 4):
            return True
