...
class AuthenticateForm(AuthenticationForm):
    ...
    """
    username = forms.CharField(required=True, widget=widgets.TextInput(attrs={"placeholder": "Username"}), error_messages={"required": "Invalid username", "inactive": "Access disallowed."})
