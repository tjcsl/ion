...
class AnnouncementForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["notify_post"].help_text = ("If this box is checked, students who have signed up for notifications "
...
class AnnouncementRequestForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["title"].help_text = ("The title of the announcement that will appear on Intranet. Please enter "
                                          "a title more specific than just \"[Club name]'s Intranet Posting\'.")
        self.fields["author"].help_text = ("If you want this post to have a custom author entry, such as "
