...
urlpatterns = [
    ...
    url(r"^/modify/(?P<announcement_id>\d+)$", views.modify_announcement_view, name="modify_announcement"),
    url(r"^/delete/(?P<announcement_id>\d+)$", views.delete_announcement_view, name="delete_announcement"),
    ...
    url(r"^/(?P<announcement_id>\d+)$", views.view_announcement_view, name="view_announcement"),
]
