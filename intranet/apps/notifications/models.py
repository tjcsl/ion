...
class UserPushNotificationPreferences(models.Model):
    ...
    eighth_waitlist_notifications = models.BooleanField("Eighth Period Waitlist Notifications", default=False)
    glance_notifications = models.BooleanField("Eighth Period Glance Notification", default=False)
    ...
    bus_notifications = models.BooleanField("Bus Notifications", default=False)
