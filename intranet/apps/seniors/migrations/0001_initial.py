...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=1000, choices=[
                        ...
                        'Psychology', 'Psychology'), ('Genetics', 'Genetics'), ('Social Work', 'Social Work'), ('Architecture', 'Architecture'), (
                            'Public Policy', 'Public Policy'), ('Classics', 'Classics'), ('Marine Biology', 'Marine Biology'), ('Dance', 'Dance'), (
                                'Philosophy', 'Philosophy'), ('Emergency Health Services', 'Emergency Health Services'), (
                                    'Animal Science', 'Animal Science'), ('Computer and Video Imaging', 'Computer and Video Imaging'),
                    ('Geography', 'Geography'), ('International Relations', 'International Relations'), ('Foreign Service', 'Foreign Service'), (
                            ...
                            'Finance', 'Finance'), ('Journalism', 'Journalism'), ('Aeronautics/Astronautics', 'Aeronautics/Astronautics'), (
                                'Pre-med', 'Pre-med'), ('Pre-law', 'Pre-law'), ('Automotive Technician', 'Automotive Technician'), (
                                    'Computer Game Design', 'Computer Game Design'), ('Petroleum Engineering', 'Petroleum Engineering'), (
                                        'American Studies', 'American Studies'), ('African-American Studies', 'African-American Studies'),
                    ('Linguistics', 'Linguistics'), ('Sociology', 'Sociology'), ('International Finance', 'International Finance'), (
                    ...
                    ('Physical Therapy', 'Physical Therapy'), ('Chemical Engineering', 'Chemical Engineering'), (
                        'Athletic Training & Physical Therapy', 'Athletic Training & Physical Therapy'), ('Civil Engineering', 'Civil Engineering'),
                    ('Industrial and Labor Relations', 'Industrial and Labor Relations'), ('Bowling Management', 'Bowling Management'), (
                        'Pre-Dental', 'Pre-Dental'), ('Aerospace Engineering', 'Aerospace Engineering'), ('French', 'French'), ('German', 'German'), (
                            'Spanish', 'Spanish'), ('Italian', 'Italian'), ('Chinese', 'Chinese'), ('Operations Research', 'Operations Research'), (
                                'Game Design and Development', 'Game Design and Development'), ('Software Engineering', 'Software Engineering'), (
                                    'International Development', 'International Development'), ('Mechanical Engineering', 'Mechanical Engineering'), (
