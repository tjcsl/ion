# Generated by Django 2.2.24 on 2021-06-28 20:16
# Manually edited to add the run_before attribute, 2022-12-14
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oauth_cslapplication', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
    ...
    # oauth2_provider's AbstractApplication initial migration must be run before our custom CSLApplication ones
    run_before = [
