...
class Sign(models.Model):
    """name A friendly name for the display display An internal code sent from the display status
    One of auto, eighth, schedule, status, url eighth_block_increment The block_increment if the
    ...
    STATUSES = (("auto", "Auto - Schedule/Eighth"), ("autourl", "Auto - URL/Eighth"), ("eighth", "Eighth Period"), ("schedule", "Bell Schedule"),
                ("status", "Schedule/Clock"), ("touch", "Touch Signage"), ("url", "Custom URL"))
    use_frameset = models.BooleanField(default=False)
    use_header = models.BooleanField(default=True)
