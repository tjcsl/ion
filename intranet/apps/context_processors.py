...
def global_custom_theme(request):
    ...
    if "halloween" in theme_names and request.COOKIES.get("disable-halloween", None) == "1":
        ...
        if "js" in theme and "themes/halloween/halloween.js" in theme["js"]:
            theme["js"] = [js for js in theme["js"] if js != "themes/halloween/halloween.js"]
        if "css" in theme and "themes/halloween/halloween.css" in theme["css"]:
            theme["css"] = [css for css in theme["css"] if css != "themes/halloween/halloween.css"]
        ...
        if "css" not in theme:
            theme["css"] = []
        theme["js"].append("themes/halloween/halloween-cookie.js")
        theme["css"].append("themes/halloween/halloween-button.css")
