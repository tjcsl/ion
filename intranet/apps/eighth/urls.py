...
eighth_admin_patterns = [
    ...
    url(r"^maintenance/teacher_management", admin_maintenance.teacher_management, name="eighth_admin_maintenance_teacher_management"),
    ...
    url(r"^groups/signup/action/(?P<group_id>\d+)/(?P<schact_id>\d+)$", groups.eighth_admin_signup_group_action, name="eighth_admin_signup_group_action"),
