...
class EighthScheduledActivityManager(Manager):
    ...
    ) -> QuerySet | Collection["EighthScheduledActivity"]:  # pylint: disable=unsubscriptable-object
...
class EighthScheduledActivity(AbstractBaseEighthModel):
    ...
    ) -> QuerySet | Collection["get_user_model()"]:  # pylint: disable=unsubscriptable-object
...
class EighthWaitlistManager(Manager):
    ...
    ) -> QuerySet | Collection["EighthWaitlist"]:  # pylint: disable=unsubscriptable-object
