    ...
    def cancel(self):
        ...
        if not self.cancelled:
            ...
            if not self.is_both_blocks or self.block.block_letter != "B":
                from .notifications import activity_cancelled_email  # noqa: E501  # pylint: disable=import-outside-toplevel,cyclic-import
                from .notifications import activity_cancelled_notification  # noqa: E501  # pylint: disable=import-outside-toplevel,cyclic-import
