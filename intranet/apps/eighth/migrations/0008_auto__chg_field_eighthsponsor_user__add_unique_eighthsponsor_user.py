...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EighthSponsor.user'
        db.alter_column(u'eighth_eighthsponsor', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.User'], unique=True, null=True))
        # Adding unique constraint on 'EighthSponsor', fields ['user']
        db.create_unique(u'eighth_eighthsponsor', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EighthSponsor', fields ['user']
        db.delete_unique(u'eighth_eighthsponsor', ['user_id'])


        # Changing field 'EighthSponsor.user'
        db.alter_column(u'eighth_eighthsponsor', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], null=True))
