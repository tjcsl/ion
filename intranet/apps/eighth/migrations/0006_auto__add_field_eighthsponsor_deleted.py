...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EighthSponsor.deleted'
        db.add_column(u'eighth_eighthsponsor', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EighthSponsor.deleted'
        db.delete_column(u'eighth_eighthsponsor', 'deleted')
