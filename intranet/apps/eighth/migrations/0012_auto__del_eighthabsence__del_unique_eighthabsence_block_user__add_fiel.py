...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EighthSignup.was_absent'
        db.add_column(u'eighth_eighthsignup', 'was_absent',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EighthSignup.was_absent'
        db.delete_column(u'eighth_eighthsignup', 'was_absent')
    ...
    models = {
        ...
        u'eighth.eighthsignup': {
            ...
            'was_absent': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
