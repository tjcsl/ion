...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EighthSignup.time'
        db.add_column(u'eighth_eighthsignup', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'EighthSignup.previous_activity_name'
        db.add_column(u'eighth_eighthsignup', 'previous_activity_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'EighthSignup.previous_activity_sponsors'
        db.add_column(u'eighth_eighthsignup', 'previous_activity_sponsors',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'EighthSignup.with_pass'
        db.add_column(u'eighth_eighthsignup', 'with_pass',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EighthSignup.pass_accepted'
        db.add_column(u'eighth_eighthsignup', 'pass_accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EighthSignup.time'
        db.delete_column(u'eighth_eighthsignup', 'time')

        # Deleting field 'EighthSignup.previous_activity_name'
        db.delete_column(u'eighth_eighthsignup', 'previous_activity_name')

        # Deleting field 'EighthSignup.previous_activity_sponsors'
        db.delete_column(u'eighth_eighthsignup', 'previous_activity_sponsors')

        # Deleting field 'EighthSignup.with_pass'
        db.delete_column(u'eighth_eighthsignup', 'with_pass')

        # Deleting field 'EighthSignup.pass_accepted'
        db.delete_column(u'eighth_eighthsignup', 'pass_accepted')
    ...
    models = {
        ...
        u'eighth.eighthsignup': {
            ...
            'previous_activity_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'previous_activity_sponsors': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
