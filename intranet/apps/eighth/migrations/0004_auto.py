...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users_allowed on 'EighthActivity'
        m2m_table_name = db.shorten_name(u'eighth_eighthactivity_users_allowed')
        ...
        db.create_unique(m2m_table_name, ['eighthactivity_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field users_allowed on 'EighthActivity'
        db.delete_table(db.shorten_name(u'eighth_eighthactivity_users_allowed'))
