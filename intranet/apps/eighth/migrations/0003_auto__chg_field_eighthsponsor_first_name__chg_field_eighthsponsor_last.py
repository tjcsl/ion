...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EighthSponsor.first_name'
        db.alter_column(u'eighth_eighthsponsor', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=63))

        # Changing field 'EighthSponsor.last_name'
        db.alter_column(u'eighth_eighthsponsor', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=63))

        # Changing field 'EighthScheduledActivity.comments'
        db.alter_column(u'eighth_eighthscheduledactivity', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'EighthActivity.deleted'
        db.add_column(u'eighth_eighthactivity', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'EighthActivity.description'
        db.alter_column(u'eighth_eighthactivity', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EighthSponsor.first_name'
        db.alter_column(u'eighth_eighthsponsor', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=63, null=True))

        # Changing field 'EighthSponsor.last_name'
        db.alter_column(u'eighth_eighthsponsor', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=63, null=True))

        # Changing field 'EighthScheduledActivity.comments'
        db.alter_column(u'eighth_eighthscheduledactivity', 'comments', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'EighthActivity.deleted'
        db.delete_column(u'eighth_eighthactivity', 'deleted')


        # Changing field 'EighthActivity.description'
        db.alter_column(u'eighth_eighthactivity', 'description', self.gf('django.db.models.fields.TextField')())
