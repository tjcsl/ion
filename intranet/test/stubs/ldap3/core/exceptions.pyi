# Stubs for ldap3.core.exceptions (Python 3.5)
#
...
class LDAPOperationResult(LDAPException):
    def __new__(cls, result: Optional[Any] = ..., description: Optional[Any] = ..., dn: Optional[Any] = ..., message: Optional[Any] = ..., response_type: Optional[Any] = ..., response: Optional[Any] = ...): ...
    result = ...  # type: Any
    ...
    type = ...  # type: Any
    response = ...  # type: Any
    def __init__(self, result: Optional[Any] = ..., description: Optional[Any] = ..., dn: Optional[Any] = ..., message: Optional[Any] = ..., response_type: Optional[Any] = ..., response: Optional[Any] = ...) -> None: ...
