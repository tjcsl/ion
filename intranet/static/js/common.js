...
$(function() {$("form.search").on("submit", function(e) { var q = $("form.search input[name=q]").val();if(q == "do a barrel roll") { e.preventDefault();ytwin("mv5qzMtLE60");setTimeout(function() { $("body").append("<style>@-webkit-keyframes roll { from { -webkit-transform: rotate(0deg) } to { -webkit-transform: rotate(360deg) } } @-moz-keyframes roll { from { -moz-transform: rotate(0deg) } to { -moz-transform: rotate(360deg) } } @keyframes roll { from { transform: rotate(0deg) } to { transform: rotate(360deg) } } body {-moz-animation-duration: 4s;-moz-animation-iteration-count: 4;-moz-animation-name: roll;-webkit-animation-name: roll; -webkit-animation-duration: 4s; -webkit-animation-iteration-count: 4;animation-name: animation-duration: 4s; animation-iteration-count: 4;}</style>"); }, 2000); } else if(q == "asteroids") { e.preventDefault(); var KICKASSVERSION='2.0';var s = document.createElement('script');s.type='text/javascript';document.body.appendChild(s);s.src='//hi.kickassapp.com/kickass.js'; $("body").append("<style>div#kickass-menu.KICKASSELEMENT {display: none !important;top: -9999px;left: -9999px;} </style>");} }); });
