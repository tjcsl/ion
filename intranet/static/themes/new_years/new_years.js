...
$(function() {
    ...
    script.onload = () => {
        function showFireworks() {
            ...
            const FireworksLib = Fireworks.default;
            const fireworks = new FireworksLib(overlay, {
                autoresize: true,
                opacity: 0.5,
                acceleration: 1.03,
                friction: 0.99,
        ...
        function markAsSeen() {
            $.cookie("new-years-fireworks-seen-" + new Date().getFullYear(), "1", { path: "/" });
        }

        const hasSeenFireworks = $.cookie("new-years-fireworks-seen-" + new Date().getFullYear()) === "1";
        if (!hasSeenFireworks) {
            showFireworks();
            markAsSeen();
        }
