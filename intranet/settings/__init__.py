...
PUSH_NOTIFICATIONS_SETTINGS = {
    ...
    "WP_CLAIMS": {"sub": "mailto:sysadmins@tjhsst.edu"},
}
...
PUSH_NOTIFICATIONS_EIGHTH_REMINDER_MINUTES = 30
...
PUSH_ROUTE_TRANSLATIONS = {
    "first and second rows, left section": {7, 8, 9, 31, 32, 33},
    "first and second rows, middle section": {3, 4, 5, 6, 34, 35, 36, 37},
    "first and second rows, right section": {1, 2, 38, 39, 40, 41},
    "back two rows, left section": {19, 20, 21, 22, 42, 43, 44, 45},
    "back two rows, middle section": {14, 15, 16, 17, 18, 27, 28, 29, 30},
    "back two rows, right section": {10, 11, 12, 13, 23, 24, 25, 26},
}
